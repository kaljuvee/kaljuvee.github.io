## Professional Bio
Julian Kaljuvee is a Director of Predictive Labs Ltd, an AI and Data Science consultancy based in the UK, and an AI engineer at Indurent, a £6bn+ Blackstone portfolio company where his responsibilities include supporting platform scale-up from a £700m REIT, supporting a multi-billion-pound merger integration, and embedding production AI capabilities across core business and investment functions. In a previous role as an AI Engineer with the Industry Solutions Delivery (ISD) group at Microsoft, he delivered several AI-focused projects for international clients across a wide range of sectors, including Anglo American (mining, LSE:AAL), Ternium (NYSE:TX, steel production) as well as ADNOC (Abu Dhabi National Oil Company, energy). Other AI-related engagements included semiconductors (ARM Holdings, NASDAQ: ARM), biotech (Vaxart Inc., NASDAQ: VXRT), and financial services (London Stock Exchange Group, LSE: LSEG), rating agencies (Morningstar, NASDAQ: MORN), among others.
